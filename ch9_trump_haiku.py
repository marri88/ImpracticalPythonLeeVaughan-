"""
2 of the speeches in the training corpus taken from: 
...
from ch9_count_syllables import count_syllables
...
def main():
	...
	intro = """\nHaiku are a traditional Japanese poetry form consisting of 17 syllables. 
While these haiku may follow that rule, they will not evoke serene or beautiful 
pictures of our natural world, since they are made from the text of Trump's 
speeches. Supposedly a president, but certainly not a poet.\n"""
	print(f"{intro}")

	raw_haiku = load_training_file("ch9_trump_speeches.txt")
